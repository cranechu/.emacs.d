...
(eval-after-load 'magit '(progn (require 'magit-popup) (unless (featurep 'jkl) (define-key magit-mode-map "i" 'magit-imerge-popup)) (when (boundp 'magit-dispatch-popup) (magit-define-popup-action 'magit-dispatch-popup 105 "Incremental merging" 'magit-imerge-popup 70))))
